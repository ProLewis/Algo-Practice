...
class DoublyLinkedList {
    ...
    isNodeInLeftHalf(node) {
        ...
        while (left != right) {
            ...
            if (right == node) return false;
            if (left.next == right) return false;
            left = left.next;
            right = right.prev;
        }
        return false;
...
const firstThreeList = new DoublyLinkedList().insertAtBackMany([1, 2, 3, 4]);
const secondThreeList = new DoublyLinkedList().insertAtBackMany([4, 5, 6]);
const unorderedList = new DoublyLinkedList().insertAtBackMany([
    -5, -10, 4, -3, 6, 1, -7, -2,
]);

//console.log(firstThreeList.nthToLast(0));

//console.log(firstThreeList.isPalindrome());

let node = firstThreeList.head;

let node2 = firstThreeList.tail


console.log(firstThreeList.isNodeInLeftHalf(node2));